...
public class M001MainAct extends BaseActivity {
    ...
    private void initData() {
        ...
        Bundle data = intent.getBundleExtra(M000SplashAct.KEY_DATA);
        Expression exp = (Expression) data.getSerializable(M000SplashAct.KEY_EXPRESSION);
